...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject earthquakeUSGS = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray earthquakeFeatures = earthquakeUSGS.getJSONArray("features");
            for (int i = 0; 1 < earthquakeFeatures.length(); i++ ) {

                JSONObject earthquakeObject = earthquakeFeatures.getJSONObject(i);
